...
var vtprotoPool_SecurityEventMessage = sync.Pool{
	New: func() interface{} {
		return &SecurityEventMessage{}
	},
}

func (m *SecurityEventMessage) ResetVT() {
	f0 := m.Data[:0]
	f1 := m.Tags[:0]
	m.Reset()
	m.Data = f0
...
func (m *SecurityEventMessage) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_SecurityEventMessage.Put(m)
	}
}
func SecurityEventMessageFromVTPool() *SecurityEventMessage {
	return vtprotoPool_SecurityEventMessage.Get().(*SecurityEventMessage)
}
